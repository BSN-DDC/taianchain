package com.reddate.taianddc.config;
...
public class ConfigInfo {
	...
	private String crossChainLogicABI;
	...
	public String getCrossChainLogicABI() {
		return crossChainLogicABI;
	}

	public void setCrossChainLogicABI(String crossChainLogicABI) {
		this.crossChainLogicABI = crossChainLogicABI;
	}

	public String getCrossChainLogicBIN() {
		return crossChainLogicBIN;
	}
