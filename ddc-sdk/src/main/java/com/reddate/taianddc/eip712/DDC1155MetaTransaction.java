...
import com.reddate.taianddc.util.crypto.PemUtil;
...
public class DDC1155MetaTransaction {
    ...
    public byte[] generateSignatureByPem(String privateKeyPem, String digest) throws Exception {

        PrivateKey privateKey = PemUtil.loadPrivateKey(privateKeyPem);
        BCECPrivateKey bcECPrivateKey = (BCECPrivateKey) privateKey;
        BigInteger privateKeyValue = bcECPrivateKey.getD();
        String hexPrivateKey = org.fisco.bcos.web3j.utils.Numeric.toHexStringNoPrefix(privateKeyValue);
