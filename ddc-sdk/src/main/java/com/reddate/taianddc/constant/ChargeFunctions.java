...
public class ChargeFunctions {
	...
	public static final String DEL_FEE = "delFee";
	public static final String DEL_DDC = "delDDC";
	...
	public static final String SET_FEE_EVENT = "SetFee(address,byte4,uint32)";
	public static final String DEL_FEE_EVENT = "DelFee(address,bytes4)";
	public static final String DEL_DDC_EVENT = "DelDDC(address)";
